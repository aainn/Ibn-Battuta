...
function searchinfo() {
    ...
    if (infoName.indexOf(" ") > 0) {
        if (infoName === "Åland Islands"    || infoName === "Bosnia and Herzegovina"|| infoName === "Bouvet Island"
            || infoName === "British Indian Ocean Territory"                        || infoName === "Antigua and Barbuda"               || infoName === "United States Minor Outlying Islands"
            || infoName === "British Indian Ocean Territory"                        || infoName === "Burkina Faso"                      || infoName === "Cayman Islands"                        || infoName === "Central African Republic"  || infoName === "Christmas Island"  || infoName === "Cocos (Keeling) Islands"
            || infoName === "Cook Islands"  || infoName === "Costa Rica"            || infoName === "Czech Republic"                    || infoName === "Dominican Republic"                    || infoName === "El Salvador"               || infoName === "Equatorial Guinea" || infoName === "Faroe Islands"
            || infoName === "French Guiana" || infoName === "French Polynesia"      || infoName === "Heard Island and McDonald Islands" || infoName === "Holy See"                              || infoName === "Hong Kong"                 || infoName === "Isle of Man"       || infoName === "Marshall Islands"
            || infoName === "New Caledonia" || infoName === "New Zealand"           || infoName === "Norfolk Island"                    || infoName === "Northern Mariana Islands"              || infoName === "Papua New Guinea"          || infoName === "Saint Barthélemy"  || infoName === "Sao Tome and Principe"
            || infoName === "Saint Helena, Ascension and Tristan da Cunha"          || infoName === "Saint Lucia"                       || infoName === "Saint Vincent and the Grenadines"      || infoName === "Saint Kitts and Nevis"     || infoName === "San Marino"        || infoName === "Saudi Arabia"
            || infoName === "Sierra Leone"  || infoName === "Solomon Islands"       || infoName === "South Africa"                      || infoName === "South Georgia and the South Sandwich Islands"                                      || infoName === "South Sudan"       || infoName === "Sri Lanka"
            || infoName === "Svalbard and Jan Mayen"                                || infoName === "Trinidad and Tobago"               || infoName === "Turks and Caicos Islands"              || infoName === "United Arab Emirates"      || infoName === "Wallis and Futuna" || infoName === "Western Sahara"
            ...
            infoName = "Syria";
        } else if (infoName === "United Kingdom of Great Britain and Northern Ireland") {
    ...
    } else { var infoName = infoName }


    urlInfo = ('http://en.wikipedia.org/w/api.php?action=parse&format=json&prop=text&section=0&page=')
...
function infoElement() {
    ...
    $.ajax({
        ...
        success: function (data, textStatus, jqXHR) {
            ...
            info.find('a').each(function () { $(this).replaceWith($(this).html()); });
